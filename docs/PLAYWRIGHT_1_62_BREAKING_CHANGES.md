...
| Bundled Chromium vs channel browsers | AUTO may drive Edge/Chrome Stable via `channel` | Dedicated `userDataDir` still Khepree Novel AI profile — not OS default profile |
